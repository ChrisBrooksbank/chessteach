...
![Position after 1.c4 (English Opening)](../../images/openings/flank-openings/english.svg)
...
flowchart TD
    ROOT["1.c4"]
    ROOT -->|"1...c5"| SYMM["Symmetrical Variation\nBattle for d4/d5"]
    ROOT -->|"1...e5"| REV_SIC["Reversed Sicilian\nSicilian with extra tempo"]
    ROOT -->|"1...Nf6 2.Nc3 g6"| VS_KID["English vs King's Indian\nMay transpose to KID"]
    ROOT -->|"1...e6"| AGNOSTIC["Can transpose to\nQGD, Catalan, etc."]
    ROOT -->|"1...Nf6 2.Nc3 ...d5"| VS_D5["May transpose to\nSlav, QGD structures"]
```
