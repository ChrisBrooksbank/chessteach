...
![Position after 1.e4 e5 2.Nf3 Nc6 3.d4 (Scotch Game)](../../images/openings/open-games/scotch-game.svg)
...
```mermaid
flowchart TD
    ROOT["1.e4 e5 2.Nf3 Nc6 3.d4 exd4"]
    ROOT -->|"4.Nxd4"| SCOTCH["Scotch Game Proper"]
    ROOT -->|"4.Bc4"| GAMBIT["Scotch Gambit\nDevelop instead of recapture"]

    SCOTCH -->|"4...Nf6 5.Nxc6"| MAIN["Main Line\n...bxc6, open play"]
    SCOTCH -->|"4...Bc5"| CLASSICAL["Scotch Classical\n...Qf6, pressure on f2"]

    GAMBIT -->|"4...Bc5 5.c3"| TRANSPOSE["May transpose to\nGiuoco Piano"]
    GAMBIT -->|"4...Nf6"| GAMBIT_MAIN["Sharp tactical play"]
```
