...
![Position after 1.d4 d5 2.c4 c6 (Slav Defense)](../../images/openings/closed-games/slav.svg)
...
```mermaid
flowchart TD
    ROOT["1.d4 d5 2.c4 c6"]
    ROOT -->|"3.Nf3 Nf6 4.Nc3 dxc4"| SLAV_MAIN["Slav Main Line\n5.a4 Bf5"]
    ROOT -->|"3.Nf3 Nf6 4.Nc3 e6"| SEMI["Semi-Slav"]

    SEMI -->|"5.e3 Nbd7 6.Bd3"| MERAN["Meran Variation\n...dxc4, ...b5, ...a6"]
    SEMI -->|"5.Bg5"| BG5["5.Bg5"]

    BG5 -->|"5...dxc4 6.e4 b5 7.e5"| BOTVINNIK["Botvinnik Variation\nExtremely sharp"]
    BG5 -->|"5...h6"| MOSCOW["Moscow Variation\n6.Bxf6 or 6.Bh4"]

    SLAV_MAIN --> SLAV_DEV["6.e3 e6 7.Bxc4\nSolid, bishop already on f5"]
```
