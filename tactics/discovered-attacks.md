...
```
Example: White Rd1, White Bf3 (blocking the rook's view of Black's Kd8).
White plays Bxb7+ (discovered check from the rook). Black must deal with the rook check.
```
