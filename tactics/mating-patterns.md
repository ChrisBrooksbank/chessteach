...
```
1.Qf7+! Kh8 (or Rxf7 and the position simplifies)
2.Qf8+! Rxf8 (forced — the queen is sacrificed!)
3.Nf7# (smothered mate — the king on h8 is surrounded by its own rook on f8 and pawns on g8/h7)
```

The queen sacrifice is the key — it forces the rook to f8, completing the "smother."
...
```
Setup: Black Kg8 (or Kh8), pawn on g7 (or h7).
White: Ne7 (covering g8 and g6), Rh1 — Rh8# or Rh7# depending on the exact position.
```
