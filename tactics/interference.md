...
```
Black's Rd8 and Rf8 defend each other along the 8th rank.
White places a piece on e8 — now the rooks are disconnected.
White can exploit whichever rook is more vulnerable.
```
