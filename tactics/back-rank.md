...
```
Black: Kg8, Rf8, pawns on f7, g7, h7.
White plays Rd8! — the rook delivers mate because:
- The king can't go to f8 (rook controls it)
- The king can't go to h8 (no escape — blocked by own pawns or controlled)
- The pawns on f7, g7, h7 block all escape squares
```
