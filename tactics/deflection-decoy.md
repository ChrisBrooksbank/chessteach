...
```
Black's Rf8 defends the back rank (preventing Rd8#).
White plays Qf7! — attacking the rook. If the rook moves, Rd8# is checkmate.
If Rxf7, the back rank is unguarded.
```
